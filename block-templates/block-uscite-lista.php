...
?>
<style>
/* Regole layout lista — specifiche uscite */
...
/* Placeholder immagine — specifico uscite */
...
/* Testi secondari uscite */
.calypso-card__subtitle{color:var(--c-wave);font-size:18px;margin:0 0 10px}
.calypso-card__meta{font-size:18px;color:#555;margin-bottom:12px;display:flex;flex-direction:column;gap:4px}
...
/* Posti disponibili — specifico uscite */
.calypso-card__spots{font-size:18px;font-weight:600;color:var(--c-wave)}
.calypso-card__spots--full{color:var(--c-coral)}
/* Badge uscite */
.calypso-card__badge{font-size:13px}
/* Bottoni */
