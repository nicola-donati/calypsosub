...
.cso-spots__num{font-family:var(--f-display);font-size:48px;font-weight:900;color:var(--c-coral);line-height:1}
...
.cso-form-row input,.cso-form-row textarea,.cso-form-row select{width:100%;padding:10px 14px;border:1.5px solid var(--c-foam);border-radius:var(--radius);font-family:var(--f-body);font-size:14px;color:var(--c-ink);transition:border-color .2s}
...
.cso-btn{display:block;width:100%;padding:14px;background:var(--c-coral);color:#fff;border:none;border-radius:var(--radius);font-family:var(--f-display);font-size:18px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;cursor:pointer;transition:background .2s,transform .15s}
